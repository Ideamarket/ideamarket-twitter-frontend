...
const HTTP_GRAPHQL_ENDPOINT =
  NETWORK === 'rinkeby'
    ? 'https://api.thegraph.com/subgraphs/name/ideamarket/ideamarketrinkeby' // 'https://subgraph-rinkeby.backend.ideamarket.io:8080/subgraphs/name/Ideamarket/IdeamarketRINKEBY'
