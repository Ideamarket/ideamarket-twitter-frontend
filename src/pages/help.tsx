...
export default function Help() {
  ...
  return (
    <>
      ...
      <div className="px-6 prose-lg md:px-12 lg:px-16 xl:px-24 md:ml-64 flex justify-center">
        <div style={{ maxWidth: '900px' }}>
          ...
          <div id="faq-prediction-manipulation">
            ...
            <p>
              ...
              rich person from inflating a listing’s capitalization. But no
              amount of money can artificially reduce the ranking of a listing
              they don’t like.
            </p>
          </div>
          ...
          <div id="faq-prediction-owning-vs-listing">
            ...
            <p>
              No. You can add @naval’s twitter account as a listing to the
              Twitter market, but only Naval can claim ownership of the interest
              that accrues to his account. He can do this by clicking “Verify”
              at the bottom of his token’s Listing Page.
            </p>
          </div>
          ...
          <div id="faq-prediction-special-rights">
            ...
            <p>
              ...
              independent of listed accounts and assets, and there should never
              be any expectation otherwise.
            </p>
          </div>
          ...
          <div id="philosophy">
            <h2>3. PHILOSOPHY</h2>
            <p>
              Ideamarket’s founding goal is to curate information sources
              without a centralized third party to offer a stamp of legitimacy
              (a mainstream media organization, for example). If Ideamarket
              becomes the new “arbiter of credibility,” replacing corporate
              anointment with public skin-in-the-game, it becomes more
              profitable to earn trust than to fake it. Genuinely trusted voices
              attain a high rank "for free" as their audience buys upvotes out
              of sincere belief and self-interest, while fake voices must pay
              out of pocket. Over time, market cycles shake out both the
