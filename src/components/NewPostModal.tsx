...
export default function NewPostModal({
  ...
  const onListClicked = async () => {
    ...
    const mintingArgs = [inputContent, selectedCategories, '', isURL, isURL ? '' : '']
  ...
  return (
    <Modal close={close}>
      <div className="w-full md:w-136 mx-auto bg-white dark:bg-gray-700 rounded-xl">
        ...
        <div className="px-6 py-4 font-bold text-2xl">
          New Post
        </div>
        ...
        <div className="px-6 py-4">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={classNames(
                  inputPostType === TX_TYPES.TEXT_POST_LIST ? 'bg-blue-100 text-blue-600' : 'bg-black/[.02] text-black',
              ...
              <button
                ...
                className={classNames(
                  inputPostType === TX_TYPES.URL_LIST ? 'bg-blue-100 text-blue-600' : 'bg-black/[.02] text-black',
                  "h-9 px-2 flex justify-center items-center space-x-1 rounded-lg border text-sm font-semibold"
                )}
              >
          ...
          <textarea
            ...
            placeholder={inputPostType === TX_TYPES.TEXT_POST_LIST ? "Create a text post..." : "Paste a URL here..." }
          />
          ...
          {inputPostType === TX_TYPES.URL_LIST && (
            <div className="my-4">
              <div className="ml-1 mb-3 text-sm font-semibold">LISTING PREVIEW</div>
