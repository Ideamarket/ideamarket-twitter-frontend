...
import TokenSelect from 'components/trade/components/TokenSelect'
import Image from 'next/image'
import { ExclamationCircleIcon } from '@heroicons/react/solid'
import { TX_TYPES } from 'components/trade/TradeCompleteModal'

type StakeUserUIBoxProps = {
  label: string
...
const StakeUserUIBox: React.FC<StakeUserUIBoxProps> = ({
  label,
  setIdeaTokenAmount,
